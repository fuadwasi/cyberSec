...
public class AfterLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (wifiCheck.isConnected()) {
            ...
            AlertDialog.Builder wifiAlt = new AlertDialog.Builder(AfterLogin.this);
        ...
        ent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ent_call = new Intent(AfterLogin.this, Enter_page.class);
        ...
        bn_b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bn_call = new Intent(AfterLogin.this,English.class);
    ...
    {
        AlertDialog.Builder exAlt = new AlertDialog.Builder(AfterLogin.this);
