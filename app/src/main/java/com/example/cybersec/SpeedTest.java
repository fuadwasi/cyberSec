...
import com.example.cybersec.test.HttpDownloadTest;
import com.example.cybersec.test.HttpUploadTest;
import com.example.cybersec.test.PingTest;
...
public class SpeedTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Conn_name = findViewById(R.id.conn_view);
      ...
      //sp_v.loadUrl("https://www.fast.com/");
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (mobileCheck.isConnected()) {
                    //Toast.makeText(getApplicationContext(),"You are Connected to ",Toast.LENGTH_LONG).show();
                    Toast.makeText(getApplicationContext(),"You are connected to Mobile Network.",Toast.LENGTH_LONG).show();
                    Conn_name.setText("Connection Name: Mobile Network");
                }
                else if( wifiCheck.isConnected())
                {
                    ...
                    Toast.makeText(getApplicationContext(),"You are connected to Wifi: "+ wifinamea,Toast.LENGTH_LONG).show();
                    Conn_name.setText("Connection Name: " + wifinamea);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                       ...
                       //     WifiInfo wifiInfoa = wifiManagera.getConnectionInfo();
//
                       //     String wifinamea = wifiInfoa.getBSSID();
                       //     Toast.makeText(getApplicationContext(),"You are Connected to "+ wifinamea,Toast.LENGTH_LONG).show();
                       // }
                        ...
                        pingRenderer.setColor(Color.parseColor("#0095ff"));
                        ...
                        downloadRenderer.setColor(Color.parseColor("#f48024"));
                        ...
                        uploadRenderer.setColor(Color.parseColor("#eb4034"));
